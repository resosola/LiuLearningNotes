...
* 使用一个变量记录上一个轮次是否发生交换，如果没发生交换过，表示序列已经有序，不必再继续排序。
...
* 有一条非常重要的性质保证了希尔排序的效率：
  ...
  * ![image-20220903121843993](../img/image-20220903121843993.png)
  ...
  增量序列的选择会极大地影响希尔排序的效率。本例中，我们采用的增量序列为 ![image-20220903121952374](../img/image-20220903121952374.png)这个序列正是当年希尔发表此算法的论文时选用的序列，所以也被称之为**希尔增量序列**。
